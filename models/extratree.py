...
tree_u=ExtraTreesRegressor(max_depth=100,n_estimators=2)
...
tree_v=ExtraTreesRegressor(max_depth=100,n_estimators=2)
...
tree_p=ExtraTreesRegressor(max_depth=100,n_estimators=2)
