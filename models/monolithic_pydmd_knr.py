...
pdmd_monolithic_velocity_u.parameters=params_train.reshape(-1,1)
rel_u_train_error=np.linalg.norm(pdmd_monolithic_velocity_u.reconstructed_data-u_train)/np.linalg.norm(u_train)

pdmd_monolithic_velocity_u.parameters=params_test.reshape(-1,1)
rel_u_test_error=np.linalg.norm(pdmd_monolithic_velocity_u.reconstructed_data-u_test)/np.linalg.norm(u_test)
...
pdmd_monolithic_velocity_v.parameters=params_train.reshape(-1,1)
rel_v_train_error=np.linalg.norm(pdmd_monolithic_velocity_v.reconstructed_data-v_train)/np.linalg.norm(v_train)

pdmd_monolithic_velocity_v.parameters=params_test.reshape(-1,1)
rel_v_test_error=np.linalg.norm(pdmd_monolithic_velocity_v.reconstructed_data-v_test)/np.linalg.norm(v_test)
...
pdmd_monolithic_velocity_p.parameters=params_train.reshape(-1,1)
rel_p_train_error=np.linalg.norm(pdmd_monolithic_velocity_p.reconstructed_data-p_train)/np.linalg.norm(p_train)

pdmd_monolithic_velocity_p.parameters=params_test.reshape(-1,1)
rel_p_test_error=np.linalg.norm(pdmd_monolithic_velocity_p.reconstructed_data-p_test)/np.linalg.norm(p_test)
