...
tree_u=BaggingRegressor(DecisionTreeRegressor(max_depth=100),n_estimators=2)
...
tree_v=BaggingRegressor(DecisionTreeRegressor(max_depth=100),n_estimators=2)
...
tree_p=BaggingRegressor(DecisionTreeRegressor(max_depth=100),n_estimators=2)
